...
export default function FleetInfo() {
    ...
    useEffect(() => {
        ...
        else if (id === "hydraulic-power-unit-3") {
        ...
        else if (id === "hydraulic-power-unit-4") {
        ...
        else if (id === "hydraulic-power-unit-5") {
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-12">
                            <div className="d-flex flex-wrap fleet_product align-items-center justify-content-between gap-5">
                                <div className="active fleet_main_p">
